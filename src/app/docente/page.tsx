        ...
        <section className="mb-6 sm:mb-8">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-2.5 relative z-10 flex-shrink-0 w-full md:w-auto">
              {/* Pendientes */}
              <div className="bg-slate-50/80 hover:bg-slate-50 border border-slate-200/80 px-3 py-2 sm:py-2.5 rounded-xl flex items-center gap-2.5 transition-colors">
                <div className="w-7 h-7 rounded-lg bg-white border border-slate-200/70 text-slate-500 flex items-center justify-center flex-shrink-0 shadow-2xs">
                  <Clock className="w-3.5 h-3.5 text-slate-500" />
                </div>
                <div>
                  <p className="text-[9px] font-black text-slate-400 uppercase tracking-wider leading-none">Pend.</p>
                  <p className="text-base sm:text-lg font-black text-slate-800 leading-tight mt-0.5">{pendientes}</p>
                </div>
              </div>
              ...
              <div className="bg-slate-50/80 hover:bg-slate-50 border border-slate-200/80 px-3 py-2 sm:py-2.5 rounded-xl flex items-center gap-2.5 transition-colors">
                ...
                <div>
                  <p className="text-[9px] font-black text-slate-400 uppercase tracking-wider leading-none">Calif.</p>
                  <p className="text-base sm:text-lg font-black text-slate-800 leading-tight mt-0.5">{calificados}</p>
                </div>
              </div>
              ...
              <div className="bg-slate-50/80 hover:bg-slate-50 border border-slate-200/80 px-3 py-2 sm:py-2.5 rounded-xl flex items-center gap-2.5 transition-colors">
                ...
                <div>
                  <p className="text-[9px] font-black text-slate-400 uppercase tracking-wider leading-none">Total</p>
                  <p className="text-base sm:text-lg font-black text-slate-800 leading-tight mt-0.5">{proyectos.length}</p>
                </div>
              </div>
            </div>
          </motion.div>
