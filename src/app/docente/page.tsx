      ...
      <main className="px-4 sm:px-6 py-5 sm:py-8 max-w-[1400px] mx-auto w-full flex-1">
        ...
        <section className="mb-6 sm:mb-8">
          ...
          >
            ...
            {/* Mini estadísticas minimalistas */}
            <div className="grid grid-cols-3 gap-2 sm:gap-2.5 relative z-10 flex-shrink-0 w-full md:w-auto">
              {/* Pendientes */}
              <div className="bg-amber-50/50 border border-amber-200/60 px-3 py-2 sm:py-2.5 rounded-xl flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-lg bg-amber-100 text-amber-600 flex items-center justify-center flex-shrink-0">
                  <Clock className="w-3.5 h-3.5" />
                </div>
                <div>
                  <p className="text-[9px] font-black text-amber-700/80 uppercase tracking-wider leading-none">Pend.</p>
                  <p className="text-base sm:text-lg font-black text-amber-800 leading-tight mt-0.5">{pendientes}</p>
                </div>
              </div>

              {/* Calificados */}
              <div className="bg-emerald-50/50 border border-emerald-200/60 px-3 py-2 sm:py-2.5 rounded-xl flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center flex-shrink-0">
                  <CheckCircle2 className="w-3.5 h-3.5" />
                </div>
                <div>
                  <p className="text-[9px] font-black text-emerald-700/80 uppercase tracking-wider leading-none">Calif.</p>
                  <p className="text-base sm:text-lg font-black text-emerald-800 leading-tight mt-0.5">{calificados}</p>
                </div>
              </div>

              {/* Total */}
              <div className="bg-blue-50/50 border border-blue-200/60 px-3 py-2 sm:py-2.5 rounded-xl flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-lg bg-blue-100 text-[#094e8f] flex items-center justify-center flex-shrink-0">
                  <BookOpen className="w-3.5 h-3.5" />
                </div>
                <div>
                  <p className="text-[9px] font-black text-blue-700/80 uppercase tracking-wider leading-none">Total</p>
                  <p className="text-base sm:text-lg font-black text-[#094e8f] leading-tight mt-0.5">{proyectos.length}</p>
                </div>
              </div>
            </div>
          </motion.div>
